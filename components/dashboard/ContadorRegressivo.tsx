...
import { diasUteisRestantes, diasUteisDecorridos, TOTAL_DIAS_UTEIS_CAMPANHA, estaEmHorarioComercial, CAMPANHA } from '@/lib/calendario/diasUteis';
...
export function ContadorRegressivo() {
  ...
  const total = TOTAL_DIAS_UTEIS_CAMPANHA;
